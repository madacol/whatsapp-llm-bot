...
export default /** @type {defineAction} */ ((x) => x)({
  ...
  formatToolCall: ({ file_path }) => `Reading ${file_path?.split("/").pop() ?? "file"}`,
  instructions: `Use read_file instead of shell commands with cat/head/tail to read files. Always read a file before editing it.
