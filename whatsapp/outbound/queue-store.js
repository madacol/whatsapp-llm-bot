 ...
 */
export async function getWhatsAppOutboundStore() {
...
export async function enqueueWhatsAppOutbound(chatId, payload, store) {
  const resolvedStore = store ?? await getWhatsAppOutboundStore();
 ...
 */
export async function deleteQueuedWhatsAppOutbound(chatId, id, store) {
  const resolvedStore = store ?? await getWhatsAppOutboundStore();
 ...
 */
export async function listQueuedWhatsAppOutbound(store) {
  const resolvedStore = store ?? await getWhatsAppOutboundStore();
