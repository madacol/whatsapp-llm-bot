...
2. Choose the highest practical proof seam.
   - Start from the seam closest to how the behavior is actually used.
   ...
   - Add narrower unit tests only as support when they isolate important logic or edge cases.
