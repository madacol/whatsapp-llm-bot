...
4. [x] Done: Split or better organize the oversized e2e adapter coverage by feature area. ACP transport coverage now lives in `tests/vertical/whatsapp-adapter-e2e.test.js`.
...
- `pnpm test tests/test-runner.test.js tests/acp-harness.test.js tests/acp-events.test.js tests/acp-file-changes.test.js tests/vertical/whatsapp-adapter-e2e.test.js tests/workspace-lifecycle.test.js tests/sendBlocks.test.js`
- `pnpm type-check`
